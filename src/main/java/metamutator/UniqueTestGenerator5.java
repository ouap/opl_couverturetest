...
public class UniqueTestGenerator5 extends AbstractProcessor<CtClass> {
	...
	public void process(CtClass element) {
		...
		try {
			...
			if ((val > seuil) && (cptMethods + element.getMethodsAnnotatedWith(getFactory().Annotation().createReference(Test.class)).size() < 5)) {
